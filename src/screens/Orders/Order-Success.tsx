  ...
  return (
    <View style={{ flex: 1,backgroundColor:'#F9FAFB'}}>
      <View style={{alignSelf: 'center'}}>
        <Image alt='OrderAnimation'
          style={{marginTop:verticalScale(25),width:120,height:120}}
          source={require('../../assets/images/Order-Success.png')}></Image>
      </View>
      <Text style={styles.OrderText} fontSize={'xl'}>Order Has been Placed Successfully</Text>
      <View
        h={16}
        borderRadius={10}
        marginRight={3}
        ...
        <View>
          <Text fontSize={'fs14'} color={'accent.900'} fontWeight={500}>Delivering to</Text>
      ...
      <View
        ...
        alignItems={'center'}
        px={2}>
        <Image style={{height:16,width:16}} alt='PaymentIcon' source={require('../../assets/images/icons/PaymentIcon.png')}></Image>
        <View flexDir={'row'}  >
          <Text fontSize={'fs14'} color={'accent.500'} ml={1} fontWeight={500} >
          Payment Method
          </Text>
          <Text fontSize={'fs14'} color={'primary.500'} fontWeight={500} ml={16}>
          Cash on Delivery
          </Text>
        </View>
      </View>
      <View
        ...
        alignItems={'center'}
        px={2}>
        <Image style={{height:16,width:16}} alt='PaymentIcon' source={require('../../assets/images/icons/WalletIcon.png')}></Image>
        <View flexDir={'row'} alignItems={'center'} justifyContent={'center'}>
          ...
          <View>
            <Image alt="smallright" source={require('../../assets/images/icons/smallright.png')}></Image>
          </View>
        </View>
      </View>
      <ImageCarousel/>
